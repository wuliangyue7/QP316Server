...
bool CDlgServerItem::GetModuleInitParameter(tagGameServerInfo * pGameServerInfo, bool bAutoMode)
{
	...
	UINT uPersonalRuleSize=sizeof(m_ModuleInitParameter.GameServiceOption.cbPersonaRule);
	CopyMemory(m_ModuleInitParameter.GameServiceOption.cbPersonaRule,pGameServerInfo->cbPersonalRule, uPersonalRuleSize);
