	...
	try
	{
		...
		for (int i = 0; i < FEE_OPTION_COUNT; i++)
		{
			...
			if (PersonalRoomOptionRightAndFee.stCreateRoomPayFee[i].dwPlayTimeLimit != 0 || PersonalRoomOptionRightAndFee.stCreateRoomPayFee[i].dwPlayTurnLimit != 0)
			{
				...
				PlatformDBAide.AddParameter(TEXT("@ExOne"),PersonalRoomOptionRightAndFee.stCreateRoomPayFee[i].nExOne);
				PlatformDBAide.AddParameter(TEXT("@ExTwo"),PersonalRoomOptionRightAndFee.stCreateRoomPayFee[i].nExTwo);
				PlatformDBAide.AddParameter(TEXT("@ExThree"),PersonalRoomOptionRightAndFee.stCreateRoomPayFee[i].nExThree);
...
bool CServerInfoManager::WritePersonalRoomInfo(tagPersonalRoomOption  PersonalRoomOption,  tagPersonalRoomOptionRightAndFee PersonalRoomOptionRightAndFee , WORD dwKindID)
{
	...
	WriteFileValue(TEXT("Option"), TEXT("IsJoinGame"), PersonalRoomOption.cbIsJoinGame, szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("MinPeople"), PersonalRoomOption.cbMinPeople, szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("MaxCellScore"), PersonalRoomOption.cbMaxPeople , szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("MaxCellScore"),PersonalRoomOption.lMaxCellScore,  szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("PersonalRoomTax"), PersonalRoomOption.lPersonalRoomTax, szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("CanCreateCount"), PersonalRoomOption.wCanCreateCount, szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("PlayTurnCount"), PersonalRoomOption.dwPlayTurnCount,  szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("PlayTimeLimit"), PersonalRoomOption.dwPlayTimeLimit, szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("TimeAfterBeginCount"), PersonalRoomOption.dwTimeAfterBeginCount, szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("TimeOffLineCount"), PersonalRoomOption.dwTimeOffLineCount, szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("TimeNotBeginGame"), PersonalRoomOption.dwTimeNotBeginGame, szIniFile);
	WriteFileValue(TEXT("Option"), TEXT("TimeAfterCreateRoom"), PersonalRoomOption.dwTimeAfterCreateRoom, szIniFile);


	//创建私人房间的权限及费用
	WriteFileValue(TEXT("CreateRoomRight"), TEXT("CreateRight"), PersonalRoomOptionRightAndFee.cbCreateRight, szIniFile);
	...
	for (int i = 0; i < FEE_OPTION_COUNT ; i++)
	{
		...
		WriteFileValue(TEXT("FeeParameter"), szPlayTurnLimit, PersonalRoomOptionRightAndFee.stCreateRoomPayFee[i].dwPlayTurnLimit, szIniFile);

		wsprintf(szPayFee, TEXT("PayFee_%d"),i);
		WriteFileValue(TEXT("FeeParameter"), szPayFee, PersonalRoomOptionRightAndFee.stCreateRoomPayFee[i].dwPayFee, szIniFile);

		wsprintf(szIniScore, TEXT("IniScore_%d"),i);
		WriteFileValue(TEXT("FeeParameter"), szIniScore, PersonalRoomOptionRightAndFee.stCreateRoomPayFee[i].dwIniScore, szIniFile);
	}
