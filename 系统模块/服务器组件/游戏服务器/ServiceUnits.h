...
//约战服务连接
#define NETWORK_PERSONAL_ROOM_CORRESPOND			2					//约战服务连接
...
public:
	...
	CTCPSocketServiceHelper			m_PrsnlRmTCPSocketService;					//网络服务
	CGameServiceManagerHelper		m_GameServiceManager;				//游戏模块
	CMatchServiceManagerHelper		m_MatchServiceManager;				//比赛管理
	CPersonalRoomServiceManagerHelper		m_PersonalRoomServiceManager;				//约战服务管理
	//接口变量
protected:
...
public:
	//记录启动服务器的数量
	void WriteSeverCount(bool bStartOrClose);
