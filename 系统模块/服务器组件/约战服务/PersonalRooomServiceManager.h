...
//比赛服务管理类
class MATCH_SERVICE_CLASS CPersonalRooomServiceManager : public IPersonalRoomServiceManager
{
	//状态变量
protected:
...
public:
	//构造函数
	CPersonalRooomServiceManager(void);
	//析构函数
	virtual ~CPersonalRooomServiceManager(void);
