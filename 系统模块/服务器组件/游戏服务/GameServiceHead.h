...
#else
#define VER_IGameServiceCustomRule INTERFACE_VERSION(1,1)
static const GUID IID_IGameServicePersonalRule ={ 0xbb76044f, 0x388e, 0x4bd7,  0xa0, 0x15, 0xb0, 0x9b, 0x93, 0x4b, 0x9f, 0x9a  };
#endif
...
{
	//获取配置
	virtual bool SavePersonalRule(LPBYTE pcbCustomRule, WORD wCustonSize)=NULL;
	//默认配置
	virtual bool DefaultPersonalRule(LPBYTE pcbCustomRule, WORD wCustonSize)=NULL;
	//创建窗口
	virtual HWND CreatePersonalRule(CWnd * pParentWnd, CRect rcCreate, LPBYTE pcbCustomRule, WORD wCustonSize)=NULL;
};
...
public:
	...
	//设置创建时间
	virtual void SetCreatePersonalTime(SYSTEMTIME tm) = NULL;
};
...
public:
	//游戏日志
	virtual void WriteGameLog( LPCTSTR pszLogString)=NULL;
};
