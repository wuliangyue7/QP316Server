...
//////////////////////////////////////////////////////////////////////////
//机器定义
#define ANDROID_SERVICE_DLL_NAME	TEXT("OxSixAndroidEx.dll")	//组件名字
...
bool CGameServiceManager::RectifyParameter(tagGameServiceOption & GameServiceOption)
{
	...
	//倍数设置
	if(pCustomRule->lTimes < 1 || pCustomRule->lTimes > 10000000)
		pCustomRule->lTimes = 1;

	//积分下限
	if (GameServiceOption.wServerType!=GAME_GENRE_SCORE)
	{
		GameServiceOption.lMinTableScore=__max(GameServiceOption.lCellScore*__max(2L,pCustomRule->lTimes),GameServiceOption.lMinTableScore);
	}
