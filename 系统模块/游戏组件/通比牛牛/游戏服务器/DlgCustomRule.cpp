...
BOOL CDlgCustomRule::OnInitDialog()
{
	...
	//设置控件
	((CEdit *)GetDlgItem(IDC_EDIT_TIMES))->LimitText(8);
...
{
	//设置数据
	SetDlgItemInt(IDC_EDIT_TIMES,m_CustomRule.lTimes);
...
{
	//设置数据
	m_CustomRule.lTimes=(LONGLONG)GetDlgItemInt(IDC_EDIT_TIMES);
	...
	//开始时间
	if ((m_CustomRule.lTimes<0)||(m_CustomRule.lTimes>10000000))
	{
