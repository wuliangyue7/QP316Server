...
BYTE CGameLogic::GetCardType(BYTE cbCardData[], BYTE cbCardCount)
{
	...
	if (cbKingCount == 2)
	{
				 ...
				 cbTempData[4] != 0x4E && cbTempData[4] != 0x4F)
		{
			...
			switch (cbCount)
			{
			case 1: return OX_VALUE_1;
			case 2: return OX_VALUE_2;
			case 3: return OX_VALUE_3;
			case 4: return OX_VALUE_4;
			case 5: return OX_VALUE_5;
			case 6: return OX_VALUE_6;
			case 7: return OX_VALUE_7;
			case 8: return OX_VALUE_8;
			case 9: return OX_VALUE_9;
			case 0: return OX_VALUE_10;
			default: ASSERT(FALSE);
			}
		}
		else return OX_VALUE_10;
	}
	...
	else if (cbKingCount == 0)
	{
		...
		if(cbJQKCount==MAX_COUNT) return OX_FIVE_KING;
		else if(cbJQKCount==MAX_COUNT-1 && cbTenCount==1) return OX_FOUR_KING;
		...
		if ((cbValue0 + cbValue1 + cbValue2) % 10 == 0)
		{
			...
			switch (cbCount)
			{
			case 1: return OX_VALUE_BIG_1;
			case 2: return OX_VALUE_BIG_2;
			case 3: return OX_VALUE_BIG_3;
			case 4: return OX_VALUE_BIG_4;
			case 5: return OX_VALUE_BIG_5;
			case 6: return OX_VALUE_BIG_6;
			case 7: return OX_VALUE_BIG_7;
			case 8: return OX_VALUE_BIG_8;
			case 9: return OX_VALUE_BIG_9;
			case 0: return OX_VALUE_BIG_10;
			default: ASSERT(FALSE);
			}
		}
	}
...
BYTE CGameLogic::GetTimes(BYTE cbCardData[], BYTE cbCardCount)
{
	...
	if (bTimes < OX_VALUE_10) return 1;
	else if (bTimes == OX_VALUE_10) return 2;
	else if (bTimes == OX_VALUE_BIG_10) return 2;
	else if (bTimes == OX_FOUR_KING) return 2;
	else if (bTimes == OX_FIVE_KING) return 2;
