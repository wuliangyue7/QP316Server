...
protected:
	...
	bool							m_bRoomCardScore;						//房卡积分模式
	LONGLONG						m_lRoomCardJetton[MAX_JETTON_AREA];		//积分房卡配置的下注
...
protected:
	...
	//控制窗口
	LRESULT OnAdminWnd(WPARAM wParam, LPARAM lParam);
	//左键视图
	LRESULT OnLButtonDownView(WPARAM wParam, LPARAM lParam);
