...
#define SUB_GF_USER_VOICE			112									//用户语音
...
#define SUB_GF_PERSONAL_MESSAGE	501									//私人房消息

//通知玩家准备
#define  SUB_GF_NOTICE_READ				502									//通知玩家准备
//////////////////////////////////////////////////////////////////////////////////
...
#define SUB_GR_CHANGE_CHAIR_COUNT 	17									//改变桌子数量

#define SUB_GF_ALREADY_CANCLE 	21									//约战房间已经被解散
#define SUB_GF_CANCLE_ERROR 	22										//约战房间解散出错
...
struct CMD_GR_PersonalTableEnd
{
	...
	SYSTEMTIME						sysStartTime;						//开始时间
	SYSTEMTIME						sysEndTime;							//结束时间
...
{
	TCHAR szMessage[260];
	BYTE  cbMessageType; // 0 代表 坐下 1 代表断线重入
};
...
//改变椅子数量
struct CMD_GR_ChangeChairCount
{
	DWORD					dwChairCount;								//椅子数量
};
//////////////////////////////////////////////////////////////////////////////////
