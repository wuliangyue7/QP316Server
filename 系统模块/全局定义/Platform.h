...
//平台常量
const TCHAR szProduct[]=TEXT("762游戏中心");							//产品名字
const TCHAR szPlazaClass[]=TEXT("762GamePlaza");						//广场类名
const TCHAR szProductKey[]=TEXT("762GamePlatform");					//产品主键

//地址定义
const TCHAR szCookieUrl[]=TEXT("http://localhost:11559");					//记录地址
const TCHAR szLogonServer[]=TEXT("127.0.0.1");						//登录地址
const TCHAR szPlatformLink[]=TEXT("http://localhost:11559");				//平台网站
const TCHAR szValidateKey[]=TEXT("RYSyncLoginKeyfor762yx");						//验证密钥
